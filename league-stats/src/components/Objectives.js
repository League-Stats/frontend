...
const Objectives = (props) => {
    ...
    return(
        <div className="objectives-container">
            ...
            <div className="objective">  
              <img src={team === "blue" ? dragon1 : baron2} className="objectives-icon" alt="dragon"/>
              <p>{details.teams[team === "blue" ? 0 : 1].dragonKills}</p>
            </div>
            <div className="objective">  
              <img src={team === "blue" ? inhib1 : baron2} className="objectives-icon" alt="inhib"/>
              <p>{details.teams[team === "blue" ? 0 : 1].inhibitorKills}</p>
            </div>
            <div className="objective">  
              <img src={team === "blue" ? herald1 : baron2} className="objectives-icon" alt="herald"/>
              <p>{details.teams[team === "blue" ? 0 : 1].riftHeraldKills}</p>
            </div>
            <div className="objective">  
              <img src={team === "blue" ? tower1 : baron2} className="objectives-icon" alt="tower"/>
